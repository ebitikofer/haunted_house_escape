...
void display(void) {
  ...
  // point4  at2(mvx, 0.0, mvz + 6.0, 1.0);
  ...
  vec3 size[NUM_OBJECTS] = {
    vec3(100, LAT_WALL_H, LAT_WALL_D),
    vec3(85.0, LAT_WALL_H, LAT_WALL_D),
    vec3(10.0, LAT_WALL_H, LAT_WALL_D),
    vec3(50.0, LAT_WALL_H, LAT_WALL_D),
    vec3(60.0, LAT_WALL_H, LAT_WALL_D),
    vec3(10.0, LAT_WALL_H, LAT_WALL_D),
    vec3(10.0, LAT_WALL_H, LAT_WALL_D),
    vec3(20.0, LAT_WALL_H, LAT_WALL_D),
    vec3(10.0, LAT_WALL_H, LAT_WALL_D),
    vec3(100, LAT_WALL_H, LAT_WALL_D),
    vec3(LON_WALL_W, LON_WALL_H, 90.0),
    vec3(LON_WALL_W, LON_WALL_H, 80.0),
    vec3(LON_WALL_W, LON_WALL_H, 5.0),
    vec3(LON_WALL_W, LON_WALL_H, 5.0),
    vec3(LON_WALL_W, LON_WALL_H, 10.0),
    vec3(LON_WALL_W, LON_WALL_H, 10.0),
    vec3(LON_WALL_W, LON_WALL_H, 40.0),
    vec3(LON_WALL_W, LON_WALL_H, 35.0),
    vec3(LON_WALL_W, LON_WALL_H, 10.0),
    vec3(LON_WALL_W, LON_WALL_H, 100)
  };
  ...
  for (i = 0; i < NUM_OBJECTS; i++) {
    object(mv, model_view, loc[i].x, loc[i].y, loc[i].z, size[i].x, size[i].y, size[i].z, LON_WALL_R, LON_WALL_G, LON_WALL_B, 0, 0, 0, 0, 0, 0);
  }
  ...
  object(mv, model_view, -50.0 + FLOOR_SIZE / 2, 17.5, -50.0 + FLOOR_SIZE / 2, ROOF_W, ROOF_H, ROOF_D, ROOF_R, ROOF_G, ROOF_B, 0, 0, 0, 0, 0, 0);
  ...
  collision(mvx, 0.0, mvz, PLAYER_W, PLAYER_H, PLAYER_D, loc, size);
